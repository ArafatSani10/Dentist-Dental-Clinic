...
const Navbar = () => {
    ...
    const activeClass = "text-black font-semibold shadow-md shadow-red-400";
            ...
            <div className="relative max-w-full mx-auto px-4">
                <div className="flex justify-between items-center h-16 relative">
                    ...
                    <NavLink to="/" className="flex-shrink-0 z-10">
                        <img src="https://i.ibb.co/7dDj9zvr/download-14.png" alt="Logo" className="w-[90px]" />
                    </NavLink>

                    {/* Desktop Nav Centered */}
                    <ul className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-6 text-[15px] font-medium text-gray-700">
                        {navLinks.map((link, idx) =>
                            link.dropdown ? (
                                ...
                                >
                                    <div className="flex items-center cursor-pointer px-4 py-3 hover:text-blue-600 transition">
                                        <span>{link.name}</span>
                                        <svg
                                            className="ml-1 w-4 h-4 transition-transform duration-300 group-hover:rotate-180 text-gray-500 group-hover:text-blue-600"
                                            fill="none"
                                            stroke="currentColor"
                                            strokeWidth="2"
                                            viewBox="0 0 24 24"
                                    ...
                                    <ul className="absolute left-0 top-full hidden group-hover:flex group-focus-within:flex flex-col bg-white text-black rounded-md shadow-md py-2 w-64 z-50">
